...
public final class LocalGroovyCommand {
    ...
    private static final String GROOVY_JAR_RESOURCE_NAME = "/groovy/groovy-3.0.6.jar";
    public static final Path GROOVY_JAR_PATH;
    private static final Map<String, Path> GROOVY_SCRIPS = new ConcurrentHashMap<>();

    static {
        try {
            GROOVY_JAR_PATH = Paths.get(LocalGroovyCommand.class.getResource(GROOVY_JAR_RESOURCE_NAME).toURI());
